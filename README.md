...
- **Databases:** MongoDB,  ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=for-the-badge&logo=mongodb&logoColor=white)  
...
- **Smart Hazard Response Platform** – A responsive disaster management dashboard built with React, TypeScript, Tailwind CSS, and shadcn/ui, providing real-time hazard alerts, severity analysis, shelter recommendations, and safe route guidance.
   - [Live Demo](https://v0-smart-hazard-response-platform-v.vercel.app/)
...
- **PostFlow (Social Media Platform)** – A platform to create, like, comment, and share posts  
  ...
  - [PostFlow Live Demo](https://post-flow-x89n-rkhk9gif5-nirmalamgrt-8293s-projects.vercel.app)
  - [Live Demo](https://backend-of-postflow.vercel.app)
